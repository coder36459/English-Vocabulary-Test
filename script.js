...
.then(function(json) {
	...
	const Test = () => {
		...
		const Footer = () => {
			return(
			React.createElement("div", { class: "m-3 text-center", id: "footer" }, "You can find more projects on my ",React.createElement("a", { href: "https://github.com/coder36459", target: "_blank" }, "GitHub"), ". If you want to find out more about me, take a look on ",React.createElement("a", { href: "https://www.linkedin.com/in/maciej-browarski", target: "_blank" }, "LinkedIn"), ".")
			);
		};
		const countDefOne = () => {
			if (count < 20) {
		...
		const choice = () => {
			...
			React.createElement("h2", { class: "text-bg-info p-4 m-3", id: "definition" }, defT.substring(0, 99)),
